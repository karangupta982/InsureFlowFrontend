...
//         <h2 className="text-2xl font-bold text-gray-900 mb-6">Vehicle Insurance Prediction</h2>
...
//         {prediction && (
//           <div className={`mt-4 p-4 rounded-md ${prediction === 'Response-Yes' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
...
//   return (
//     <div className="max-w-3xl mx-auto p-1 mt-[2vh] text-black bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl shadow-2xl ">
//       <form onSubmit={handleSubmit} className="space-y-8 p-10 bg-white rounded-lg shadow-lg">
//         <h2 className="text-3xl font-extrabold text-gray-900 text-center">🚗 Vehicle Insurance Prediction</h2>
        
//         <div className="grid grid-cols-2 gap-6">
//           {Object.keys(formData).map((key) => (
//             <div key={key}>
//               <label className="block text-lg font-semibold text-gray-800">{key.replace(/_/g, ' ')}</label>
//               {key === 'Gender' || key === 'Driving_License' || key === 'Previously_Insured' || key === 'Vehicle_Damage_Yes' ? (
//                 <select
//                   name={key}
//                   onChange={handleChange}
//                   className="mt-2 block w-full p-3 rounded-lg border-gray-300 shadow-sm text-lg focus:border-indigo-500 focus:ring-indigo-500"
//                 >
...
//           type="submit"
//           disabled={loading}
//           className="w-full bg-indigo-600 text-white py-3 px-6 rounded-lg text-xl font-semibold hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
//         >
//           {loading ? 'Predicting...' : '🚀 Predict'}
//         </button>

//         {prediction && (
//           <div className={`mt-6 p-6 rounded-lg text-xl font-semibold text-center ${prediction === 'Response-Yes' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
//             🎯 Prediction Result: {prediction}
//           </div>
//         )}
//       </form>
